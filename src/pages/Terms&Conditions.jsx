            ...
            <Card className="shadow border-0 rounded-4">
                ...
                <Card.Body className="px-md-5 py-4">
                    <p className="text-muted fs-5 mb-5">
                        These Terms and Conditions ("Terms") govern your use of the <strong>Varahi Self Drive Cars</strong> application ("App"). By accessing or using the App, you agree to comply with and be bound by these Terms.
                    </p>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            <a
                                href="https://mail.google.com/mail/?view=cm&to=help.varahiselfdrivecars@gmail.com&su=Terms%20and%20Conditions&body=Hello"
                                target="_blank"
